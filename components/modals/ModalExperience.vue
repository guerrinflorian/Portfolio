...
const mExperiencesFR = [
  {
    ...
    points: [
      ...
      'Architecture SQL Server autonome sur les modules développés : création de tables, procédures stockées (CRUD), vues et synonymes pour la portabilité entre environnements',
...
const mExperiencesEN = [
  {
    ...
    points: [
      ...
      'Autonomous SQL Server architecture on developed modules: table creation, stored procedures (CRUD), views and synonyms for cross-environment portability',
